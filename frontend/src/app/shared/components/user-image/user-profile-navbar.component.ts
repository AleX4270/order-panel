...
@Component({
    ...
    template: `
        ...
        <div class="user-data-container d-flex justify-content-start align-items-center dropdown">
            ...
            <div class="ms-3 mt-1 d-flex justify-content-start align-items-center dropdown-toggle" data-bs-toggle="dropdown">
                <button class="btn bg-transparent border-0 p-0">{{user()?.username}}</button>
            </div>
